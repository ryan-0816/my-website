...
<script lang="ts">
  ...
  const baseAbout = `Hi! I'm Ryan, currently at RIT focusing on a cybersecurity majorand a mathematics minor. I am in the accelerated BS/MS program, so I plan to graduate with both degrees in May of 2028. I am currently looking to apply my technical and practical skills in a co-op in summer of 2026 in cybersecurity, computer science, information technology, or a related field. 
  
  I love partaking in cybersecurity related activities, playing sports, and my sense of community here at college! The rest of this page summarizes my resume, along with some other hobbies and things about me!`;
  ...
  • This website, which is mainly Svelte, but uses a bit of TypeScript, CSS, and React
  ...
  • Maintained secure work environments by regulating access and monitoring inventory.
  ...
  • Attended active workshops to continually learn the best teaching methods
  ...
  <i>Summer 2025</i>
  • Led hands-on STEM activities in electronics, robotics, and programming for youth.
  ...
  I love building Lego. My wallet does not. But in particular I love the Lego Star Wars series such as the Imperial Star Destroyer (75394), and from the starship collection: Millenium Falcon (75375), Executive Super Star Destroyer (75356), hopefully the Venator next year.
  
  <b>Gaming</b>
  I've played my fair share of Minecraft, but I also enjoy co-op games such as Left 4 Dead 2, Lethal Company, Deep Rock Galactic, BTD6, Stick Fight, and Helldivers II.
  
  <b>Typing</b>
  I have always enjoyed typing as something simple and repetitive to destress. There are a variety of fun typing games that I have enjoyed; I also explored different layouts, having switched to Colemak for about half a year. Although it didn't stick, it was still a cool experience. I like the A2449 Apple Magic keyboard. 
  
  <b>Stenography</b>
  I started learning stenography using Plover just under a year and a half ago, buying a hobbyist keyboard to get started. Since then I have practiced in my free time, creating my own dictionaries and phrasing styles. I enjoy the logic and learning new chords every day.
  
  <b>Outdoor Activities</b>
  I love spending time outdoors. Whether that's going for hikes, roller blading, or just being outside on a sunny day. I also enjoy riding an electric unicycle to get around campus. I also love mountain biking, either downhill or just around local trails.
  `;

  const about5 = `<b>Alpine Ski Racing</b>
  I grew up skiing at the only hill in Rhode Island, taking the occasional trip up to Vermont. Winter has always been my favorite season in part due to this. When I came to RIT and saw they had an alpine ski team, I immediately joined despite never having thought of racing before. I became secretary for the club this year, managing records and administrative paperwork to do my part in sharing skiing opportunities with the RIT community.

  <b>Sailing</b>
  I started sailing on a Snapir OD 11 and a Sunfish, but really started learning when I joined my high school's 420 fleet, practicing dinghy sailing and attending regattas throughout the state. I also joined my local Sea Scouts chapter to gain more experience, sailing keelboats weekly through the summers. One of my favorite memories was sailing for a week on the USCGC Eagle. I have also sailed for a season with RIT's competitive team based in Sodus Bay. Some of my favorite classes to sail/race are the C420, Laser, J110, and Farr 40. 
  ...
  RITSEC is a large organization made up of mostly cybersecurity majors. Through this club, I have participated in competitions such as Incident Response Security Competition and Cyber Operations Remediation Assessment. I have also attended interest groups focusing on topics from CTF competitions to vulnerability assesments to offensive security techniques. Additionally, I have done mentorships focusing on Terraform and Scapy. Lastly, I attend weekly meetings and workshops to stay current on cybersecurity tools and threats.
  
  <b>Chinese Conversation Table Club</b>
  This club meets weekly to better each other's Mandarin speaking skills through casual conversation practice. We also celebrate traditions such as Mid-Autumn Moon Festival and Chinese New Year. I joined this club last year, and took on the role of treasurer this year.
  
  <b>Climate and Sustainability Leadership Organization</b>
  Dedicated to furthering sustainability initiatives both at RIT and for individual members, I have attended volunteering opportunities and other various activities through this club.
  
  <b>Outing Club</b>
  I enjoy hiking and being outside, and this club caters to that type by hosting weekend getaways to various hiking trails every weekend. I attended the Fall Break 2025 trip, camping for three nights in the Adirondacks. 
  `
  ...
  const projectTiles: Required<Card>["photoGrid"] = [
    ...
    { src: "/photos/network script.png", href: "https://github.com/ryan-0816/Scripts", alt: "Network intrusion monitor" },
  ...
  const sportsTiles: Required<Card>["photoGrid"] = [
    ...
    { src: "/photos/eagle1.jpg", href: "#", alt: "Eagle" },
    { src: "/photos/dog.jpg", href: "#", alt: "Adobe" },
  ...
  const hobbiesTiles: Required<Card>["photoGrid"] = [
    ...
    { src: "/photos/helldiver.jpg", href: "#", alt: "Sodus Sailing" },
    { src: "/photos/stickfight.jpg", href: "#", alt: "Sailing at uscga" },
    { src: "/photos/stenoss.png", href: "#", alt: "Monkeytype ss" },
    { src: "/photos/steno2.png", href: "#", alt: "Steno and case" },
    { src: "/photos/steno.jpg", href: "#", alt: "Helldiver Salute" },
  ...
  const sections: Card[] = [
    ...
    { heading: "Hobbies", about: about4, photoGrid: hobbiesTiles, height: 720, clickableImages: false }
  ];
          ...
          {#if s.photoGrid}
            ...
            >
              {#each s.photoGrid as tile}
                ...
                {:else}
                  <div class="project-thumb non-clickable">
                    <img src={tile.src} alt={tile.alt ?? 'Section image'} loading="lazy" decoding="async" />
                    <div class="gloss"></div>
                  </div>
                {/if}
...
<style>
  ...
  .project-thumb.non-clickable {
    cursor: default;
  }
  .project-thumb.non-clickable:hover {
    transform: none;
    box-shadow: inset 0 1px 0 rgba(255,255,255,0.05);
  }
